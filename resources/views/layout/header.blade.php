                 ...
                 <ul class="navbar-nav ml-auto">
                         ...
                         <form action="/tim-kiem" method="get" autocomplete="off">
                             <div class="input-group">
                                 <input class="form-control border-end-0 border rounded-pill" type="text"
                                     placeholder="Tìm Kiếm..." id="keywords" name="keywords_submit" required>
                                 <button
                                     class="btn btn-outline-secondary bg-black border-start-0 border rounded-pill ms-n3"
                                     type="submit">
                     ...
                     @if (Auth::check())
                         <li>
                             <div class="dropdown">
                                 <button
                                     class="btn btn-outline-info btn-md btn-rounded btn-navbar waves-effect waves-light dropdown-toggle"
                                 ...
                                 <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                                     ...
                                     <a class="dropdown-item"
                                         href="{{ route('capnhatthongtin', Auth::user()->id) }}">Tài Khoản</a>
                                     <hr>
                                     @if (Auth::user()->role == 1)
                     ...
                     @else
                         <li class="nav-item">
                             <a href="{{ route('relogin') }}" type="button"
                                 class="btn btn-outline-info btn-md btn-rounded btn-navbar waves-effect waves-light">Đăng
                                 nhập</a>
                         </li>
                     @endif
                     @if (Auth::check())
