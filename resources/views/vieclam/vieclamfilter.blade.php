...
@section('content')
    ...
    <div class="page-heading about-heading header-text"
        style="background-image: url(https://cdn.shopify.com/s/files/1/1404/4249/files/2020-02-06_BANNER_TUY_N_D_NG.jpg?v=1581044229);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <div class="products">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div class="contact-form">
                        <form action="{{ route('filter') }}" method="get">
                            <button type="submit" class="btn btn-primary btn-sm float-right">Lọc <i class="fa fa-filter"
                ...
                <div class="col-md-9">
                    <h4 style="padding: 10px 10px; background-color: red; color: white; margin-bottom:10px"
                        class="text-center">Tin Tuyển Dụng</h4>
                    <div class="row">
                                    ...
                                    <div class="product-item">
                                        <a href="/vieclam/chi-tiet-viec-lam/{{ $val->id }}">
                                            <img src="{{ asset('anh_tintuyendung/' . $val->anh) }}"
                                                style="width:100%; height:200px; padding: 8px;border-radius: 15px;" alt="">
                                            <div style="height: 200px;" class="down-content">
                                                ...
                                                <h5 style="color: black;"><small><i class="fa fa-briefcase"></i>
                                                        {{ $val->nganhnghe }} <br> <i class="fa fa-building"></i>
                                                        {{ $val->tenquan }}</small></h5>
                                            </div>
                                        </a>
                                        <div class="row mt-5">
                                            <div class="col-12 text-center">
                                                <form action="/vieclam/luu-viec-lam/{{ $val->id }} " method="post">
                                                    @csrf
                                                    <button type="submit" class="btn btn-xs btn-outline-danger btn-flat"
                                                        data-toggle="tooltip"><i class="far fa-save"> Lưu việc
                                                            làm</i></button>
                                                </form>
                                            </div>
                                        </div>
