            ...
            <div class="container blog">
                <div class="row" style="margin-top: -50px">
                    <div class="col-md-3 blog-left">
                        ...
                        <br />
                        <br />
                        <a href="/blog/danhsach"
                            style="color:rgb(8, 8, 8); border-radius: 20px; padding:15px; background-color: #f3f3e9">QUẢN LÍ
                            BLOG</a>
                    </div>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <form action="{{ route('blog1.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row blog-form">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Tên người viết *"
                                                    value="" name="tennguoiviet" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
