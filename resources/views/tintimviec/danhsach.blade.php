...
@section('content')
    <div class="services">
        <div class="container-fluid">
            <h3 style="text-align: center; margin-top: -50px">Quản lí tin tìm việc</h3>
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ route('tintimviec1.trash') }}"
                    ...
                    <div class="add" style="margin: 20px 0">
                        <button class="btn btn-primary"><a style="color:aliceblue;"
                                href="{{ route('tintimviec1.create') }}">Thêm</a></button>
                            ...
                            <tbody>
                                ...
                                @foreach ($tintimviecs as $al)
                                    ...
                                    <tr id="sid{{ $al->id }}">
                                        ...
                                        <td>{{ $al->nganhnghe }}</td>
                                        <td>{{ $al->diachi }}</td>
                                        <td><img src="{{ asset('anh_tintimviec/' . $al->anh) }}"
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-xs btn-warning">
                                                <a href="{{ route('tintimviec1.edit', $al->id) }}"><i
