...
@section('content')
    <img width="100%" height="300px"
        src="https://blogcdn.muaban.net/wp-content/uploads/2018/01/h%E1%BB%93-s%C6%A1-%E1%BB%A9ng-vi%C3%AAn-t%C3%ACm-vi%E1%BB%87c-2.jpg"
        alt="">
    <div class="products">
        <div class="container">
            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="anhcanhan">
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-12 text-center">
                                                                <form action="{{ route('luuhoso', $al->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <button type="submit"
                                                                        class="btn btn-xs btn-outline-danger btn-flat"
                                                                        data-toggle="tooltip"><i class="far fa-save"> Lưu
                                                                            hồ sơ</i></button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-7">
                                                    <div class="thongtin">
                                                        <h4 style="padding-bottom: 60px; padding-top: 10px;">
                                                            {{ $al->ten }}</h4>
                                                        <p><i class="fas fa-venus-mars"></i> Giới tính:
                                                            {{ $al->gioitinh }}
                                                        </p>
                                                        <p><i class="fas fa-briefcase"></i> Ngành nghề:
                                                            {{ $al->nganhnghe }}
                                                        </p>
                                                        <p><i class="fas fa-calendar-alt"></i> Ngày đăng:
                                                            {{ \Carbon\Carbon::parse($al->created_at)->format('d/m/Y') }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
